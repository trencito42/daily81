...
export function PencilIcon({ className = "w-4 h-4", active = false }: { className?: string; active?: boolean }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="18"
    ...
    >
      ...
      <path d="m15 5 4 4" />
      {active && <circle cx="12" cy="12" r="10" strokeDasharray="3 3" />}
    </svg>
  );
}
...
export function EraseIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="18"
...
export function HintIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="18"
